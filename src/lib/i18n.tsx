...
const dict = {
  ...
  en: {
    ...
    "faq.a2": "Each invitation specifies the names of invited guests. If you have any doubts, please contact us directly.",
    "faq.q3": "Are children welcome?",
    "faq.a3": "We love children! If you're bringing kids, please indicate it in the RSVP so we can prepare accordingly.",
    "faq.q4": "What is the dress code?",
    "faq.a4": "Cocktail/Formal. Feel comfortable and amazing! Please save white for the bride. Bright colors are welcome.",
    "faq.q5": "Is there parking on-site?",
    "faq.a5": "Yes! Quinta Glicínia has private and free parking for all guests.",
    "faq.q6": "Is there accommodation nearby?",
    "faq.a6": "Quinta Glicínia has on-site accommodation with check-in from 3:00 PM. For reservations, please contact us directly.",
    "faq.q7": "Can I take photos during the ceremony?",
    "faq.a7": "We kindly ask that you enjoy the ceremony with us and let our photographer do the work. After the ceremony, feel free — and don't forget our shared album!",
    "faq.q8": "How do I give a gift?",
    "faq.a8": "Your presence is our greatest gift. If you wish to contribute, you'll find our details in the 'Gifts' section.",
    "faq.q9": "I have dietary restrictions. What should I do?",
    "faq.a9": "No problem! Just indicate all restrictions in the RSVP form and we'll take care of the rest.",
    "faq.q10": "Until what time does the party last?",
    "faq.a10": "The party goes until dawn! We're ready to dance the night away with you.",
