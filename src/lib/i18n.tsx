...
const dict = {
  pt: {
    ...
    "rsvp.thanksDesc": "A tua resposta foi recebida com amor. Mal podemos esperar por ti no dia 19 de Novembro!",
  ...
  en: {
    ...
    "rsvp.thanksDesc": "Your reply has been received with love. We can't wait to celebrate November 19 with you!",
