...
const dict = {
  pt: {
    ...
    "home.when": "sábado, 14h00",
    "home.days": "faltam",
    "home.cta.directions": "Como chegar",
    "home.cta.rsvp": "Confirmar presença",
    "home.essentials": "O essencial",
    "home.e.date": "Sábado, 19 de Setembro de 2026",
    "home.e.time": "Cerimónia às 14h00 · chega até às 13h45",
    "home.e.place": "Glicínia Wedding House · Freamunde",
    "home.e.dress": "Cores alegres · o branco é da noiva",
    "home.s.photos": "Fotografias",
    "home.s.rsvp": "Confirmar",
    "home.s.message": "Mensagem",
    "home.s.gifts": "Presentes",

    "place.kicker": "Como chegar",
    "place.address": "Glicínia Wedding House, Freamunde · Paços de Ferreira",
    "place.addressLabel": "Endereço",
    "place.copy": "Copiar endereço",
    "place.copied": "Copiado!",
    "place.when.title": "A que horas chegar",
    "place.when.desc": "A cerimónia começa pontualmente às 14h00. Chega entre as 13h30 e as 13h45 para te acomodares com calma.",
    "place.contact": "Falar connosco",
    "place.accommodation": "Alojamento",
    "place.accommodation.desc": "Na quinta, 15h00",

    "more.title": "Mais",
    "more.subtitle": "tudo num só sítio",
    "more.back": "Voltar",
    "more.info": "Informações práticas",
    "more.info.desc": "Traje, alojamento, estacionamento",
    "more.gifts": "Presentes",
    "more.gifts.desc": "IBAN, Revolut e MB WAY",
    "more.msg": "Deixar uma mensagem",
    "more.msg.desc": "Só nós vamos ler",
    "more.story": "A nossa história",
    "more.story.desc": "2020 — 2026",
    "more.share": "Partilhar o site",
    "more.share.desc": "Enviar a quem falta",
    "more.install": "Adicionar ao ecrã",
    "more.install.desc": "Fica como uma app",
    "faq.seeAll": "Ver as 9 perguntas",
    ...
    "memories.title": "FOTOGRAFIAS",
    "memories.subtitle": "o nosso álbum oficial",
    "memories.desc": "Partilha connosco os momentos mais especiais do nosso dia. Adiciona as tuas fotografias e vídeos ao álbum oficial do casamento.",
    "memories.primary": "Ver fotografias",
    "memories.secondary": "Adicionar fotografias",
    "memories.stepsTitle": "EM 3 PASSOS SIMPLES",
    "memories.step1": "Aponta a câmara do telemóvel para o QR code",
    "memories.step2": "Adiciona as tuas fotografias e vídeos do nosso dia",
    "memories.step3": "Vê todas as memórias partilhadas pelos convidados",
    "memories.openPhone": "Abrir no Telemóvel",
    "memories.note": "Todas as fotografias serão guardadas no álbum oficial do casamento.",
    ...
    "faq.a5": "A Quinta Glicínia dispõe de alojamento no local com check-in a partir das 15h00, preferencialmente logo após a cerimónia. Para reservas, contactem-nos diretamente.",
    ...
    "rsvp.confirm.subtitle": "Resumo da tua confirmação",
    "rsvp.confirm.attending.yes": "Sim, vou estar presente",
    "rsvp.confirm.attending.no": "Não poderei estar presente",
    "rsvp.confirm.notProvided": "Não indicado",
    "rsvp.confirm.another": "Enviar outra resposta",
    "rsvp.step": "Passo",
    "rsvp.of": "de",
    "rsvp.step1": "Presença",
    "rsvp.step2": "Contactos",
    "rsvp.step3": "Detalhes",
    "rsvp.next": "Continuar",
    "rsvp.back": "Voltar",
  ...
  en: {
    ...
    "home.when": "Saturday, 2:00 PM",
    "home.days": "only",
    "home.cta.directions": "How to get there",
    "home.cta.rsvp": "RSVP",
    "home.essentials": "The essentials",
    "home.e.date": "Saturday, September 19, 2026",
    "home.e.time": "Ceremony at 2:00 PM · arrive by 1:45 PM",
    "home.e.place": "Glicínia Wedding House · Freamunde",
    "home.e.dress": "Bright colours · white is for the bride",
    "home.s.photos": "Photos",
    "home.s.rsvp": "RSVP",
    "home.s.message": "Message",
    "home.s.gifts": "Gifts",

    "place.kicker": "How to get there",
    "place.address": "Glicínia Wedding House, Freamunde · Paços de Ferreira",
    "place.addressLabel": "Address",
    "place.copy": "Copy address",
    "place.copied": "Copied!",
    "place.when.title": "When to arrive",
    "place.when.desc": "The ceremony starts punctually at 2:00 PM. Arrive between 1:30 and 1:45 PM to settle in calmly.",
    "place.contact": "Talk to us",
    "place.accommodation": "Accommodation",
    "place.accommodation.desc": "On-site, 3:00 PM",

    "more.title": "More",
    "more.subtitle": "everything in one place",
    "more.back": "Back",
    "more.info": "Practical information",
    "more.info.desc": "Dress code, stay, parking",
    "more.gifts": "Gifts",
    "more.gifts.desc": "IBAN, Revolut and MB WAY",
    "more.msg": "Leave a message",
    "more.msg.desc": "Only we will read it",
    "more.story": "Our story",
    "more.story.desc": "2020 — 2026",
    "more.share": "Share the site",
    "more.share.desc": "Send it to who's missing",
    "more.install": "Add to home screen",
    "more.install.desc": "Works like an app",
    "faq.seeAll": "See all 9 questions",
    ...
    "memories.subtitle": "our official album",
    "memories.desc": "Share with us the most special moments of our day. Add your photos and videos to our official wedding album.",
    "memories.primary": "View photos",
    "memories.secondary": "Add photos",
    ...
    "memories.note": "All photos will be saved in our official wedding album.",
    ...
    "faq.a5": "Quinta Glicínia has on-site accommodation with check-in from 3:00 PM, ideally right after the ceremony. For reservations, please contact us directly.",
    ...
    "rsvp.confirm.subtitle": "Summary of your confirmation",
    "rsvp.confirm.attending.yes": "Yes, I'll be there",
    "rsvp.confirm.attending.no": "Unfortunately I can't make it",
    "rsvp.confirm.notProvided": "Not provided",
    "rsvp.confirm.another": "Send another response",
    "rsvp.step": "Step",
    "rsvp.of": "of",
    "rsvp.step1": "Attendance",
    "rsvp.step2": "Contact",
    "rsvp.step3": "Details",
    "rsvp.next": "Continue",
    "rsvp.back": "Back",
